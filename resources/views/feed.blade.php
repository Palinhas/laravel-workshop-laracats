...
<body
    class="text-pixl-light flex gap-8 xl:gap-16 px-4 sm:h-dvh sm:overflow-clip"
>
<!-- Navigation -->
<header class="w-48 hidden shrink-0 my-4 pl-4 xl:ml-40 sm:flex flex-col gap-8 justify-between">
    ...
    <!--       User Controls-->
    <div class="h-12 flex gap-3.5">
        <a href="/profile" class="shrink-0">
            <img src="/images/adrian.png" alt="Adrian for Adrian" class="size-11 object-cover">
        </a>
        <div class="flex flex-col gap-1 text-sm">
            <p>_adrian</p>
            <p class="text-pixl-light/60">@tudssss</p>
        </div>
        <button class="flex gap-[3px] group" aria-label="Post options">
...
<main class="flex grow flex-col gap-4 overflow-y-auto py-4 px-4 -mx-4">
    ...
    <div class="flex mt-8 gap-4 items-start border-b border-pixl-light/10 pb-4">
        ...
        <form class="grow" action="">
            ...
            <textarea
                class="text-lg w-full resize-none items-center"
                name="post" id="post"
            ...
            <div class="flex justify-between gap-4">
                ...
                <button class="bg-pixl hover:bg-pixl/90 active:bg-pixl/95 text-pixl-dark border border-transparent px-4 py-1 text-sm" type="submit">Post</button>
            </div>
        </form>
    </div>
    <!-- Feed -->
                ...
                <div class="border-pixl-light/10 border-b pb-5">
                    ...
                    <div class="flex items-center justify-between gap-4">
                        <div class="flex items-center gap-2.5">
                            ...
                            <p>
                                <a class="text-xs text-pixl-light/40 hover:text-pixl-light/60" href="/profile">@mmich_jj</a>
                            </p>
                        </div>
                        <button class="flex gap-[3px] group" aria-label="Post options">
                            <span class="size-1 bg-pixl-light/40 group-hover:bg-pixl-light/60"></span>
                    ...
                    <!-- Reply Form-->
                    <div class="flex mt-8 gap-4 items-start border-t border-pixl-light/10 bg-pixl/[3%] p-4">
                        <a href="/profile" class="shrink-0"><img src="/images/adrian.png"
                                                                 alt="Avatar for Adrian"
                                                                 class="size-10 object-cover"></a>
                        <form class="grow" action="">
                            ...
                            <textarea
                                class="text-sm w-full resize-none items-center"
                                name="reply"
                                id="reply"
                                rows="5"
                            ...
                            <div class="flex justify-between gap-4">
                                ...
                                <button class="bg-pixl/10 hover:bg-pixl/15 active:bg-pixl/20 text-pixl border border-transparent px-4 py-1 text-sm" type="submit">Post</button>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <ol>
                    ...
                    <li class="relative flex items-start gap-4 pt-4 group/li">
                        ...
                        <div class="grow border-b border-pixl-light/10 pb-5 pt-1.5">
                            <div class="flex items-center justify-between gap-4">
                                <div class="flex items-center gap-2.5">
                                    <p><a class="hover:underline" href="/profile">Simon</a></p>
                                    <p class="text-xs text-pixl-light/40">1h</p>
                                    <p>
                                        <a class="text-xs text-pixl-light/40 hover:text-pixl-light/60" href="/profile">@simon</a>
                                    </p>
                                </div>
                                <button class="flex gap-[3px] group" aria-label="Post options">
                                    <span class="size-1 bg-pixl-light/40 group-hover:bg-pixl-light/60"></span>
                            ...
                            <div class="mt-4 text-sm flex flex-col gap-3">
                                <p class="">Heh - this looks just like me!.
                                </p>
                            </div>
                            <!-- Action buttons -->
                            <div class="flex items-center justify-between gap-4 mt-6">
    ...
    <div class="mt-10 border border-pixl-light/10 p-4">
        ...
        <ol class="flex flex-col gap-4 mt-4">
            ...
            <li class="flex items-center justify-between gap-4">
                ...
                <button
                    class="bg-pixl-dark/50 hover:bg-pixl-dark/60 active:bg-pixl-dark/75 border-pixl/50 active:border-pixl/75 hover:border-pixl/60 text-pixl border px-2 py-1 text-sm"
                >Follow</button
                >
            </li>
            <li class="flex items-center justify-between gap-4">
                <div class="flex items-center gap-2.5">
                    ...
                    <p class="text-sm truncate">jstt_anne</p>
